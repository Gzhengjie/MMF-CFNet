...
class StarNet(nn.Module, EncoderMixin):
    def __init__(self, out_channels=(3, 32, 24, 48, 96, 192), depth=5, base_dim=32, depths=[3, 3, 12, 5], mlp_ratio=4, drop_path_rate=0.0, num_classes=1000, **kwargs):
        super().__init__()
...
starnet_encoders = {
    "starnet_s1": {
        "encoder": StarNet,
        "params": {
            "out_channels": (3, 32, 24, 48, 96, 192),
            "base_dim": 24,
            "depths": [2, 2, 8, 3],
        },
    },
    "starnet_s2": {
        "encoder": StarNet,
        "params": {
            "out_channels": (3, 32, 32, 64, 128, 256),
            "base_dim": 32,
            "depths": [1, 2, 6, 2],
        },
    },
