...
def TifCrop(TifPath, SavePath, CropSize, RepetitionRate, FileName):
    print("读取数据")
        ...
        for j in range(int((width - CropSize * RepetitionRate) / (CropSize * (1 - RepetitionRate)))):
            ...
            #  如果图像是多波段
                ...
                cropped = img[:,
                          ...
                          int(j * CropSize * (1 - RepetitionRate)): int(j * CropSize * (1 - RepetitionRate)) + CropSize]
            #  写图像
            writeTiff(cropped, geotrans, proj, SavePath + "\\" + str(new_name) + "-" + FileName)
            #  文件名 + 1
            new_name = new_name + 1
